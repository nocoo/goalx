...
func TestDurableSurfaceRegistryResolvesKnownSurfaces(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "protocol-composition", class: DurableSurfaceClassStructuredState, writeMode: DurableSurfaceWriteModeReplace, strict: true, wantPath: ProtocolCompositionPath(runDir)},
