...
func TestRenderMasterProtocolIncludesTransitionRecommendationInstructions(t *testing.T) {
	...
	for _, want := range []string{
		...
		"Supported `next_config` keys: `parallel`, `engine`, `model`, `preset`, `diversity_hints`, `strategies`, `budget_seconds`, `objective`, `harness`.",
		`{"phase":"complete","recommendation":"implement","heartbeat":5,"acceptance_met":true,"next_config":{"objective":"implement the agreed P0/P1 fixes","parallel":3,"diversity_hints":["P0 fixes","P1 fixes","verification"],"engine":"codex","model":"codex","budget_seconds":7200}}`,
		...
		`{"phase":"complete","recommendation":"more-research","heartbeat":5,"acceptance_met":false,"next_objective":"investigate the unresolved auth edge cases","next_config":{"parallel":2,"strategies":["depth","adversarial"],"budget_seconds":3600}}`,
